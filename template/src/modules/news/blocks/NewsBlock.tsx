...
import type { NewsBlock as NewsBlockType } from "@/generated/graphql/graphql";
...
type NewsBlockProps = Partial<Omit<NewsBlockType, "__typename" | "innerBlocks">>;

/**
 * Displays a curated selection of news from WordPress.
 * Module: @citeopolis/news
 *
 * Theme SCSS override: themes/{theme}/modules/news/blocks/NewsBlock.module.scss
 * Component override: themes/{theme}/components/ (not applicable for blocks)
 */
export default function NewsBlock({ anchor, briefNews, focusedNews, listUrl, news, proposeUrl }: NewsBlockProps) {
  return (
