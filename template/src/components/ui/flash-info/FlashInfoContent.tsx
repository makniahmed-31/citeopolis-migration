...
export default function FlashInfoContent({
  item: flashInfo,
}: FlashInfoContentProps) {
  return (
    <div className={styles.flashInfo}>
      <i
        className={clsx("fa fa-triangle-exclamation", styles.topIcon)}
        aria-hidden="true"
      ></i>
      {flashInfo.url ? (
        <div className={styles.wrapper}>
          ...
          <i
            className={clsx("fa fa-plus", styles.plusIcon)}
            aria-hidden="true"
          ></i>
        </div>
      ) : (
        <div className={styles.content}>
          {flashInfo.title && (
            <h3 className={styles.title}>{flashInfo.title}</h3>
          )}
          {flashInfo.description && (
            <p className={styles.description}>{flashInfo.description}</p>
          )}
        </div>
      )}
    </div>
